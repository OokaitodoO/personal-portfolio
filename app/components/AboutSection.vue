<template>
    <div class="flex flex-col py-6 md:flex-row">
        <div class="flex flex-col gap-3 md:border-e md:pr-6 lg:w-5xl">
            <div class=" rounded-4xl bg-purple-100 p-4 size-fit">
                <h1 class=" text-2xl text-purple-500">KM</h1>
            </div>
            <div>
                <p>Kanjanawat Muangkam (Mixer)</p>
                <p class=" font-light">Email : m.kanjanawat@gmail.com</p>
                <p class=" font-light">Tel : +66 61-431-5900</p>
        ...
        <div class="flex flex-col pt-4 md:pl-6 md:pt-0">
            <p>I'm a Junior Game/Web Developer passionate about creating engaging experiences. I focus on
                building
                constructive games and modern web applications, constantly learning and improving my craft.</p>
